...
$q1 = "SELECT * FROM `products` INNER JOIN categories c USING(category_id) WHERE c.category_name = 'Urządzenia peryferyjne'";

$res = $conn->query($q1);
?>

<h1 class="subtitle">Urządzenia peryferyjne</h1>
